TERMID=200
TERMNAME=ss24
FIRSTTERMID=199 # no data before WS09/10
...
# MSCE
# python fetch_curriculum_tree.py --curriculum master-msce
python print_html_table.py --termid $TERMID --curriculum master-msce --output "../msce-$TERMNAME.html"